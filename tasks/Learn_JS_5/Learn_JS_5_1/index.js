...
// Ошибки из-за того, что при обращении к примитивам через . создаётся объект-обёртка и в него записываются мои свойства
// объект получает моё свойство, но после удаляется, поэтому text и value не имеют данных свойств и методов
